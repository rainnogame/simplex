...
use common\models\article\ArticleRecordSearch;
use Yii;
use common\models\article\ArticleRecord;
use common\ext\controllers\SimplexController;
 ...
 */
class ArticleController extends SimplexController
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new ArticleRecordSearch();
