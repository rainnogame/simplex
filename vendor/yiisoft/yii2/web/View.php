...
class View extends \yii\base\View
{
     ...
     *                        the supported options. The following options are specially handled and are not treated as
     *                        HTML attributes:
     *
     ...
     *                               This will adjust depending assets javascript file position or fail if requirement
     *                               can not be met. If this is null, asset bundles position settings will not be
     *                               changed. See [[registerJsFile]] for more details on javascript position.
     *
