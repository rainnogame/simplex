 ...
 * @property array                                   $errors           An array of errors for all attributes. Empty
 *           array is returned if no error. The result is a two-dimensional array. See [[getErrors()]] for detailed
 *           description. This property is read-only.
 * @property array                                   $firstErrors      The first errors. The array keys are the
 *           attribute names, and the array values are the corresponding error messages. An empty array will be
 *           returned if there is no error. This property is read-only.
 * @property ArrayIterator                           $iterator         An iterator for traversing the items in the
 *           list. This property is read-only.
...
class Model extends Component implements IteratorAggregate, ArrayAccess, Arrayable
{
     ...
     *      Note that when returning errors for all attributes, the result is a two-dimensional array, like the
     *      following:
     *
     * ```php
     * [
